...
async def save_bot_username(bot):
    """Save the bot's username to environment variable for use in web app"""
    try:
        bot_info = await bot.get_me()
        username = bot_info.username
        os.environ["BOT_USERNAME"] = username
        logging.info(f"Bot username saved: {username}")
    except Exception as e:
...
def main():
    ...
    # We'll use a post_init callback to handle the bot username
    # This is properly handled in the setup_bot function
